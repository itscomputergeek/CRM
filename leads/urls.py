...
from .views import (
    lead_list,lead_detail,lead_create,lead_update,lead_delete,LandingPageView,
    LeadListView,LeadDetailView,LeadCreateView,LeadUpdateView,LeadDeleteView,AssignAgentView,CategoryListView,
    CategoryDetailView,LeadCategoryUpdateView,CategoryCreateView,CategoryUpdateView,CategoryDeleteView,FollowUpUpdateView,FollowUpCreateView,FollowUpDeleteView,LeadJsonView
